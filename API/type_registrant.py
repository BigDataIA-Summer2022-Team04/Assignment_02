...
# Defined functions
def type_registrant(state_short: str):
    ...
    -------
    json
        1. Aggregate of count of planes based on type of registrant
        2. Records of flight number, serial number, state name, registrant type
    """
...
def main(state_code: str = 'MA'):
    ...
    data = type_registrant(state_code)
